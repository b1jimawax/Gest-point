...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2>Modification de l'apprenant</h2>
      <?php 
...
include("connexion.php");
  ...
  $sql = "SELECT * FROM apprenant WHERE idapprenant = $idapprenant";
...
?>
    ...
    <form method="POST" action="m.php">
        ...
        <div class="mb-3">
          <input class="form-control form-control-lg" type="text" name="prenom" id="prenom" value="<?php echo $row["prenom"]; ?>" >
        </div>
        <div class="mb-3">
          <input class="form-control form-control-lg" type="text" name="nom" id="nom" value="<?php echo $row["nom"]; ?>">
        </div>
        <div class="mb-3">
          <select class="form-select form-select-lg mb-3" type="text" name="referenciel" id="referenciel" value="<?php echo $row["referenciel"]; ?>" >
            <option selected>Développeur web/web mobile</option>
            <option value="Réferent(e) Digital">Réferent(e) Digital</option>
          </select>
          </div>
            <button type="reset" class="btn btn-outline-danger">Annuler</button>&nbsp&nbsp
