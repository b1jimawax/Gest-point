...
$sql = "select idconnexion,heure_de_connexion, prenom, referenciel from connexion inner join apprenant on connexion.idapprenant=apprenant.idapprenant ORDER BY `idconnexion` DESC";
...
<?php
    ...
    echo "
      ...
      <th scope='col'>#</th>
      <th scope='col'>Date/Heures-m-s</th>
    ...
    while ($row = $result->fetch_assoc()) {
        echo "
            ...
            <tr>
                <td>" . $row["idconnexion"] . "</td>
                <td>" . $row["heure_de_connexion"] . "</td>
                <td>" . $row["prenom"] . "</td>
